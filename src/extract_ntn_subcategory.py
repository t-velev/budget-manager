...
subcategory_new_data = get_data(subcategory_db_id, last_load_date, filter_cols=None)
...
filtered_data = get_data(subcategory_db_id, last_load_date=None, filter_cols=filter_cols)
