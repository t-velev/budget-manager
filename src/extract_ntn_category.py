...
category_new_data = get_data(category_db_id, last_load_date, filter_cols=None)

# For testing purposes during development
# with open('./data/notion_category_extract.json', 'r', encoding='utf-8') as file:
#   category_new_data = json.load(file)

print(f'Retrieved {len(category_new_data)} new rows from Notion.')
...
filtered_data = get_data(category_db_id, last_load_date=None, filter_cols=filter_cols)
